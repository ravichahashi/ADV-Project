      ...
      <header id="header" className="fixed-top">
        ...
        <nav className="main-nav float-right d-none d-lg-block">
          <ul>
            <li>
              <a href="/landing">
              <svg width="3em" height="3em" viewBox="0 1 20 20" class="bi bi-house-door" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a href>
              <svg width="3em" height="3em" viewBox="0 1 20 20" class="bi bi-chat-dots" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a href>
              <svg width="3em" height="3em" viewBox="0 1 20 20" class="bi bi-bell" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
